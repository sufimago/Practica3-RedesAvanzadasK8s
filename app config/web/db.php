...
// Conectar con Redis y base de datos en producción
$redis = new Redis();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($check_result->num_rows == 0) {
        ...
        // Limpiar la caché en Redis al agregar un nuevo producto
        $redis->del($cache_key);
    }
}

// Intentar cargar los productos de la caché en Redis
