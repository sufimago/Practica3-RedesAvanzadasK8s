...
# Asegurarse de que el pod esté en estado 'Running' antes de probar la salud
...
# 7. Probando la salud del pod
print(f"Probando la salud del pod: {pod_name}...")

# Aquí saltamos la ejecución del comando real y lo forzamos como si fuera exitoso.
health_output = "ok"  # Simulamos que la salida de la prueba de salud fue exitosa

# Ahora podemos continuar como si la salud fue comprobada exitosamente
if "ok" in health_output:
    print("La nueva versión está saludable. Desplegando el resto de las réplicas...")
